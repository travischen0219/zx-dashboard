...
class Material_unitController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('settings.material_unit.index', compact('material_units'));
    }
    ...
    {
        $data = [];
        $data['unit'] = new Material_unit;

        return view('settings.material_unit.create', $data);
    }
    ...
    public function store(MaterialUnitRequest $request)
    {
        ...
        if(Material_unit::count() > 0) {
            $final_orderby = Material_unit::orderBy('orderby', 'DESC')->first()->orderby;
        } else {
            $final_orderby = 0;
        }
    ...
    public function edit($id)
    {
        ...
        return view('settings.material_unit.edit', compact('unit'));
    }
