<script type="text/x-template" id="material-table">
    <div class="card card-default">
        <div class="card-body">
            <h4>
                物料清單
                <button type="button" @click="listMaterial(rows.length)" class="btn btn-primary btn-add">
                    <i class="fa fa-plus"></i> 新增物料
                </button>
                <button type="button" @click="listMaterialModule" class="btn btn-primary btn-add">
