    ...
    <div class="col-md-12 ">
        ...
        <div class="portlet light">
            ...
            <div class="portlet-body form">
                <form role="form" action="{{ route('account_receivable.store') }}" method="POST" id="account_receivable_from">
                    {{ csrf_field() }}
                    <div class="form-body">
                            ...
                            <div class="col-md-3">
                                <div class="form-group form-md-line-input">
                                    <select class="form-control" id="status" name="status">
                                        <option value="1" {{old('status') == 1 ? 'selected' : ''}}>未收款</option>
                                        <option value="2" {{old('status') == 2 ? 'selected' : ''}}>已收款</option>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-3">
                                <div class="form-group form-md-line-input" >
                                    <input type="text" name="receivableDate" class="form-control" autocomplete="off" id="datepicker02" value="{{ old('receivableDate') }}">
                                    <label for="datepicker02" style="color:#248ff1;">收款日期 (YYYY-MM-DD)</label>
                                    <span class="help-block"></span>
                                </div>
                            </div>
                            <div class="col-md-3" style="font-size: 16px;color:#248ff1;line-height: 50px;">
                                會計單號 : <span style="color:#000">AR{{$account_receivable_no}}</span>
                                <input type="hidden" name="account_receivable_no" value="{{$account_receivable_no}}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-3">
                                <div class="form-group form-md-line-input" >
                                    <input type="text" name="discount" class="form-control" id="discount" onchange="total();" onkeyup="total();">
