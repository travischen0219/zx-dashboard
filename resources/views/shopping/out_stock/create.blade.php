    ...
    <div class="col-md-12 ">
        ...
        <div class="portlet light">
            ...
            <div class="portlet-body form">
                <form role="form" action="{{ route('out_stock.store') }}" method="POST" id="out_from">
                    {{ csrf_field() }}
                    <div class="form-body">
                        ...
                        <div class="col-md-12" style="height:90px;">
                            ...
                            <div class="col-md-3">
                                <div class="form-group form-md-line-input" >
                                    <input type="text" name="outDate" class="form-control" autocomplete="off" id="datepicker01" value="{{ old('outDate') }}">
                                    <label for="datepicker01" style="color:#248ff1;">出庫日期 (YYYY-MM-DD)</label>
                                    <span class="help-block"></span>
                                </div>
                            </div>
                        </div>
...
<button id="error_outDate" class="btn btn-danger mt-sweetalert" data-title="出庫日期 必填" data-message="" data-allow-outside-click="true" data-confirm-button-class="btn-danger" style="display: none;"></button>
...
<button id="error_price" class="btn btn-danger mt-sweetalert" data-title="售價不可為負值" data-message="" data-allow-outside-click="true" data-confirm-button-class="btn-danger" style="display: none;"></button>
...
function addMaterial() {
    $.post(
        "{{ route('select_material_out_stock.addRow') }}",
...
function setMaterial_module(module_id){
    $.magnificPopup.close();
    $.post(
        "{{ route('select_material_module_out_stock.addModule') }}",
