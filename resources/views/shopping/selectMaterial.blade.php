...
<div class="page-content">
    ...
    <div class="row">
        <div class="col-md-12" >
            <form role="form" action="{{ route('selectMaterial_inventory.search') }}" method="POST" id="search_from">
                {{ csrf_field() }}
            ...
            <div class="portlet light">
                <div class="portlet-title">
                    ...
                    <div class="caption font-dark">
                        <span style="color:red;">只顯示有庫存的物料</span>
                    </div>
                    <div class="tools"> </div>
                </div>
                            ...
                            @foreach($materials as $material)
                                ...
                                <tr>
                                    <td align="center" id="functions_btn">
                                        <a href="javascript:;" class="btn blue btn-outline btn-sm" onclick="parent.setMaterial('{{$material->fullCode}}','{{$material->fullName}}','{{$material->buy}}','{{$material->unit}}','{{$material->cost}}','{{$material->price}}','{{$material->id}}','{{$material->warehouse_name->code}}','{{$material->material_unit_name->name}}','{{$material->stock}}','{{$material->warehouse > 0 ? $material->warehouse : ''}}','{{$material->warehouse > 0 ? $material->warehouse_name->code : ''}}');">選擇</a>    
                                    </td>
