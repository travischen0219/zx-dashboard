    ...
    <div class="col-md-12 ">
        ...
        <div class="portlet light">
            ...
            <div class="portlet-body form">
                <form role="form" action="{{ route('apply_out_stock.update',$apply->id) }}" method="POST" id="apply_from" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    {{ method_field('PUT') }}
                    ...
                    <div class="form-body">
                        ...
                        <div class="col-md-12" style="height:90px;">
                            <div class="col-md-3">
                                <div class="form-group form-md-line-input" >
                                    <input type="text" name="lot_number" class="form-control" id="lot_number" value="{{ $apply->lot_number }}" readonly>
                            ...
                            <div class="col-md-3">
                                <div class="form-group form-md-line-input" >
                                    ...
                                    @elseif($apply->sale_no != '')
                                        <input type="text" name="sale_no" class="form-control" id="sale_no" value="S{{ $apply->sale_no }}" readonly>
                                    @else
                                        <input type="text" name="sale_no" class="form-control" id="sale_no" @if($apply->status == 2) disabled @endif>
                                    @endif
                                ...
                                <div class="col-md-3">
                                    <div class="form-group form-md-line-input">
                                        <select class="form-control" id="status" name="status">
                                            <option value="1" {{$apply->status == 1 ? 'selected' : ''}}>申請中</option>
                                            <option value="2" {{$apply->status == 2 ? 'selected' : ''}}>已通過</option>
                                        </select>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-3">
                                <div class="form-group form-md-line-input" >
                                    <input type="text" name="applyDate" class="form-control" autocomplete="off" id="datepicker01" value="{{ $apply->applyDate }}" {{ $apply->status == 2 ? 'disabled' : ''}}>
                            ...
                            <div class="col-md-3">
                                <div class="form-group form-md-line-input" >
                                    <input type="text" name="expireDate" class="form-control" autocomplete="off" id="datepicker02" value="{{ $apply->expireDate }}" {{ $apply->status == 2 ? 'disabled' : ''}}>
                            ...
                            <div class="col-md-3">
                                <div class="form-group form-md-line-input" >
                                    <input type="text" name="receiveDate" class="form-control" autocomplete="off" id="datepicker03" value="{{ $apply->receiveDate }}" {{ $apply->status == 2 ? 'disabled' : ''}}>
                            ...
                            <div class="portlet light bordered">
                                ...
                                <div class="portlet-body">
                                    <div style="margin-left:7px;margin-bottom: 10px;">
                                        <a href="javascript:addMaterial();" class="btn btn-primary" {{ $apply->status != 1 ? 'style=display:none;' : ''}}><i class="fa fa-plus"></i> 新增物料</a>
                                                ...
                                                <p style="margin-top:6px;margin-bottom: 50px">
                                                    <a href="javascript:;" class="btn red pull-right btn-sm" role="button" onclick="
                                                        if(confirm('確定要刪除嗎 ?')){
                                                            ...
                                                            document.getElementById('delete-form-{{$apply->image_1->id}}').submit();
                                                        } else {
                                                            event.preventDefault();
                                                        }">刪除</a>
                                            ...
                                            <div class="caption">
                                                ...
                                                <p style="margin-top:6px;margin-bottom: 50px">
                                                    <a href="javascript:;" class="btn red pull-right btn-sm" role="button" onclick="
                                                        if(confirm('確定要刪除嗎 ?')){
                                                            event.preventDefault();
                                                            document.getElementById('delete-form-{{$apply->image_2->id}}').submit();
                                                        } else {
                                                            event.preventDefault();
                                                        }">刪除</a>
                                            ...
                                            <div class="caption">
                                                ...
                                                <p style="margin-top:6px;margin-bottom: 50px">
                                                    <a href="javascript:;" class="btn red pull-right btn-sm" role="button" onclick="
                                                        if(confirm('確定要刪除嗎 ?')){
                                                            event.preventDefault();
                                                            document.getElementById('delete-form-{{$apply->image_3->id}}').submit();
                                                        } else {
                                                            event.preventDefault();
                                                        }">刪除</a>
...
@if($apply->file_1 > 0)
    <form id="delete-form-{{$apply->image_1->id}}" action="{{ url('shopping/apply_file/delete/1/'. $apply->id.'/'.$apply->image_1->id) }}" method="post" style="display:none">
        {{ csrf_field() }}
    </form>
@endif
@if($apply->file_2 > 0)
    <form id="delete-form-{{$apply->image_2->id}}" action="{{ url('shopping/apply_file/delete/2/'. $apply->id.'/'.$apply->image_2->id) }}" method="post" style="display:none">
        {{ csrf_field() }}
    </form>
@endif
@if($apply->file_3 > 0)
    <form id="delete-form-{{$apply->image_3->id}}" action="{{ url('shopping/apply_file/delete/3/'. $apply->id.'/'.$apply->image_3->id) }}" method="post" style="display:none">
        {{ csrf_field() }}
    </form>
@endif
...
<button id="error_receiveDate" class="btn btn-danger mt-sweetalert" data-title="通過日期 必填" data-message="" data-allow-outside-click="true" data-confirm-button-class="btn-danger" style="display: none;"></button>
