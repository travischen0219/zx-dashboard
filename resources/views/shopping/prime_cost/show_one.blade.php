            ...
            <div class="portlet-body form">                                         
                    <div class="form-body">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-3">
                                <div class="form-group form-md-line-input" >
                                    <input type="text" name="createDate" class="form-control" id="datepicker01" value="{{ $sale->createDate }}" {{ $sale->status == 2 ? 'disabled' : ''}}>
                            ...
                            <div class="col-md-3">
                                <div class="form-group form-md-line-input" >
                                    <input type="text" name="expireDate" class="form-control" id="datepicker02" value="{{ $sale->expireDate }}" {{ $sale->status == 2 ? 'disabled' : ''}}>
                            ...
                            <div class="col-md-3">
                                <div class="form-group form-md-line-input" >
                                    <input type="text" name="receiveDate" class="form-control" id="datepicker03" value="{{ $sale->receiveDate }}" {{ $sale->status == 2 ? 'disabled' : ''}}>
                        ...
                        <div class="col-md-12" style="margin-top:10px;">
                            <div class="well">
                                <span>編輯人員 : {{ $updated_user->fullname }} @if($updated_user->delete_flag != 0) <span style="color:red;">(該人員已刪除)</span> @endif</span><br>
                                <span>編輯完成時間 : {{ $sale->profit_at }}</span>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">        
                            <div class="form-actions noborder">
                                <a href="{{ route('prime_cost.index') }}" class="btn blue"><i class="fa fa-reply"></i> 返 回</a>   
                            </div>
                        </div>
                    </div>
            </div>
