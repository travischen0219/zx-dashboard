    ...
    <div class="col-md-12 ">
        ...
        <div class="portlet light">
            ...
            <div class="portlet-body form">
                <form role="form" action="{{ route('s_sales_return.store') }}" method="POST" id="sale_from" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    ...
                    <div class="form-body">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-3">
                                <div class="form-group form-md-line-input" >
                                    <input type="text" name="returnDate" class="form-control" autocomplete="off" id="datepicker01">
                            ...
                            <div class="col-md-3">
                                <div class="form-group form-md-line-input" >
                                    <input type="text" name="realReturnDate" class="form-control" autocomplete="off" id="datepicker02">
...
<button id="error_expireDate" class="btn btn-danger mt-sweetalert" data-title="退貨完成日 必填" data-message="" data-allow-outside-click="true" data-confirm-button-class="btn-danger" style="display: none;"></button>
