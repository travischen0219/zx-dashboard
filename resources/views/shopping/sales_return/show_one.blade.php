            ...
            <div class="portlet-body form">                                         
                    <div class="form-body">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-3">
                                <div class="form-group form-md-line-input" >
                                    <input type="text" name="returnDate" class="form-control" id="datepicker01"  {{ $sale->status == 2 ? 'disabled' : ''}}>
                            ...
                            <div class="col-md-3">
                                <div class="form-group form-md-line-input" >
                                    <input type="text" name="realReturnDate" class="form-control" id="datepicker02" {{ $sale->status == 2 ? 'disabled' : ''}}>
                        ...
                        <div class="col-md-12">        
                            <div class="form-actions noborder">
                                <a href="{{ route('s_sales_return.index') }}" class="btn blue"><i class="fa fa-reply"></i> 返 回</a>   
                            </div>
                        </div>
                    </div>
            </div>
