...
<div class="page-content">
    ...
    <div class="row">
        <form role="form" action="{{ route('selectMaterial_module_inventory.search') }}" method="POST">
            {{ csrf_field() }}
            <div class="col-md-12" >
            ...
            <div class="portlet light">
                <div class="portlet-title">
                    ...
                    {{-- <div class="caption font-dark">
                        <a href="{{ route('material_module.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> 新增販售模組</a>
                    </div> --}}
                    <div class="tools"> </div>
                </div>
                            ...
                            @foreach($modules as $material_module)
                                ...
                                <tr>
                                    <td align="center" id="functions_btn">
                                        <a href="javascript:;" class="btn blue btn-outline btn-sm" onclick="parent.setMaterial_module('{{$material_module->id}}');">選擇</a>    
                                    </td>
