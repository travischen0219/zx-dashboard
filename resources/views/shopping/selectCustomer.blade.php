...
<div class="page-content">
    ...
    <div class="row">
        <div class="col-md-12" >
            <form role="form" action="{{ route('selectCustomer.search') }}" method="POST" id="search_from">
                {{ csrf_field() }}
        ...
        <div class="col-md-12">
            ...
            <div class="portlet-title">
                ...
                <div class="caption font-dark" style="margin-left:20px;">
                    <a href="{{ route('createCustomer') }}" class="btn btn-primary"><i class="fa fa-plus"></i> 新增客戶</a>
                </div>
                            ...
                            @foreach($customers as $customer)
                                ...
                                <tr>
                                    <td align="center" id="functions_btn">
                                        <a href="javascript:;" class="btn blue btn-outline btn-sm" onclick="parent.setCustomer('{{$customer->code}}','{{$customer->shortName}}','{{$customer->id}}');">選擇</a>
                                    </td>
                                    <td>{{$customer->code}}</td>
                                    <td>
