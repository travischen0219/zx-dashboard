                    ...
                    <div class="form-body">
                        ...
                        <div class="col-md-12" style="height:90px;">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group form-md-line-input">
                                        <select class="form-control" id="status" name="status">
                                            ...
                                            <option value="2" {{$sale->status == 2 ? 'selected' : ''}}>已完成</option>
                                        </select>
                            ...
                            @elseif($sale->status == 2) --}}
                                <div class="col-md-3" style="font-size: 16px;color:#248ff1;line-height: 50px;">
                                    狀態 : <span style="color:blue">換貨完成</span> 
                                </div>
                            {{-- @endif --}}
                            <div class="col-md-3" style="font-size: 16px;color:#248ff1;line-height: 50px;">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-3">
                                <div class="form-group form-md-line-input" >
                                    <input type="text" name="exchangeDate" class="form-control" id="datepicker01" disabled>
                            ...
                            <div class="col-md-3">
                                <div class="form-group form-md-line-input" >
                                    <input type="text" name="realExchangeDate" class="form-control" id="datepicker02" disabled>
                                    <label for="datepicker02" style="color:#248ff1;">換貨完成 (YYYY-MM-DD)</label>
                                    <span class="help-block"></span>
                                </div>
                            </div>
                        ...
                        <div class="col-md-12">        
                            <div class="form-actions noborder">
                                <a href="{{ route('s_exchange.index') }}" class="btn blue"><i class="fa fa-reply"></i> 返 回</a>   
                            </div>
                        </div>
                    </div>
            </div>
...
$( function() {
    ...
    $( "#datepicker01" ).datepicker('setDate', "{{ $sale->exchangeDate }}");
    
    $( "#datepicker02" ).datepicker();
    $( "#datepicker02" ).datepicker('option', "dateFormat", "yy-mm-dd");
    $( "#datepicker02" ).datepicker('option', 'firstDay', 1);
    $( "#datepicker02" ).datepicker('setDate', "{{ $sale->realExchangeDate }}");
