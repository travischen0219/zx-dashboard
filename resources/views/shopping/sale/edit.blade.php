    ...
    <div class="col-md-12 ">
        ...
        <div class="portlet light">
            ...
            <div class="portlet-body form">
                <form role="form" action="{{ route('sale.update',$sale->id) }}" method="POST" id="sale_from" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    {{ method_field('PUT') }}
                    ...
                    <div class="form-body">
                        ...
                        <div class="col-md-12" style="height:90px;">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group form-md-line-input">
                                        <select class="form-control" id="status" name="status">
                                            <option value="1" {{$sale->status == 1 ? 'selected' : ''}}>新訂單</option>
                                            <option value="2" {{$sale->status == 2 ? 'selected' : ''}}>新報價</option>
                                            <option value="3" {{$sale->status == 3 ? 'selected' : ''}}>已完成</option>
                                            <option value="4" {{$sale->status == 4 ? 'selected' : ''}}>取消</option>
                                        </select>
                            ...
                            @elseif($sale->status == 4)
                                <div class="col-md-3" style="font-size: 16px;color:#248ff1;line-height: 50px;">
                                    狀態 : <span style="color:blue">取消</span>
                                </div>
                            @endif
                            <div class="col-md-3" style="font-size: 16px;color:#248ff1;line-height: 50px;">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-3">
                                <div class="form-group form-md-line-input" >
                                    <input type="text" name="createDate" class="form-control" autocomplete="off" id="datepicker01" value="{{ $sale->createDate }}">
                            ...
                            <div class="col-md-3">
                                <div class="form-group form-md-line-input" >
                                    <input type="text" name="expireDate" class="form-control" autocomplete="off" id="datepicker02" value="{{ $sale->expireDate }}">
                            ...
                            <div class="col-md-3">
                                <div class="form-group form-md-line-input" >
                                    <input type="text" name="receiveDate" class="form-control" autocomplete="off" id="datepicker03" value="{{ $sale->receiveDate }}">
                                    <label for="datepicker03" style="color:#248ff1;">完成日期 (YYYY-MM-DD)</label>
                                    <span class="help-block"></span>
                                </div>
                            </div>
...
@if($sale->file_1 > 0)
    <form id="delete-form-{{$sale->image_1->id}}" action="{{ url('shopping/sale_file/delete/1/'. $sale->id.'/'.$sale->image_1->id) }}" method="post" style="display:none">
        {{ csrf_field() }}
    </form>
@endif
@if($sale->file_2 > 0)
    <form id="delete-form-{{$sale->image_2->id}}" action="{{ url('shopping/sale_file/delete/2/'. $sale->id.'/'.$sale->image_2->id) }}" method="post" style="display:none">
        {{ csrf_field() }}
    </form>
@endif
@if($sale->file_3 > 0)
    <form id="delete-form-{{$sale->image_3->id}}" action="{{ url('shopping/sale_file/delete/3/'. $sale->id.'/'.$sale->image_3->id) }}" method="post" style="display:none">
        {{ csrf_field() }}
    </form>
@endif
...
<button id="error_receiveDate" class="btn btn-danger mt-sweetalert" data-title="完成日期 必填" data-message="" data-allow-outside-click="true" data-confirm-button-class="btn-danger" style="display: none;"></button>
