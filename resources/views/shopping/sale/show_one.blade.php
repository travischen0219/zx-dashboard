                    ...
                    <div class="form-body">
                        ...
                        <div class="col-md-12" style="height:90px;">
                            ...
                            @elseif($sale->status == 4)
                                <div class="col-md-3" style="font-size: 16px;color:#248ff1;line-height: 50px;">
                                    狀態 : <span style="color:#ACB5C3">取消</span> 
                                </div>
                            @endif
                            <div class="col-md-3" style="font-size: 16px;color:#248ff1;line-height: 50px;">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-3">
                                <div class="form-group form-md-line-input" >
                                    <input type="text" name="createDate" class="form-control" id="datepicker01" value="{{ $sale->createDate }}" disabled>
                            ...
                            <div class="col-md-3">
                                <div class="form-group form-md-line-input" >
                                    <input type="text" name="expireDate" class="form-control" id="datepicker02" value="{{ $sale->expireDate }}" disabled>
                            ...
                            <div class="col-md-3">
                                <div class="form-group form-md-line-input" >
                                    <input type="text" name="receiveDate" class="form-control" id="datepicker03" value="{{ $sale->receiveDate }}" disabled>
                            ...
                            <div class="col-md-12">
                                <div class="form-group form-md-line-input">
                                    <textarea class="form-control" rows="3" name="memo" id="memo" disabled>{{ $sale->memo }}</textarea>
                        ...
                        <div class="col-md-12">        
                            <div class="form-actions noborder">
                                <a href="{{ route('sale.index') }}" class="btn blue"><i class="fa fa-reply"></i> 返 回</a>   
                            </div>
                        </div>
                    </div>
            </div>
