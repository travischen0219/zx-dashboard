        ...
        <div class="portlet box">
            ...
            <div class="portlet-body">
                ...
                <div class="tabbable-line">
                    ...
                    <div class="tab-content">
                            ...
                            <form class="login-form" action="{{ route('login') }}" method="post" id="name_form">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control form-control-solid placeholder-no-fix" type="text"
                                        autocomplete="off" placeholder="帳號" name="username" /> </div>
                                <div class="form-group">
                                    ...
                                    <input class="form-control form-control-solid placeholder-no-fix" type="password"
                                        autocomplete="off" placeholder="密碼" name="password" /> </div>
                        ...
                        <div class="tab-pane" id="tab_15_2">
                            ...
                            <form class="login-form" action="{{ route('login') }}" method="post" id="code_form">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control form-control-solid placeholder-no-fix" type="text"
                                        autocomplete="off" placeholder="員工編號" name="usercode" /> </div>
                                <div class="form-group">
                                    <label class="control-label visible-ie8 visible-ie9">密碼</label>
                                    <input class="form-control form-control-solid placeholder-no-fix" type="password"
                                        autocomplete="off" placeholder="密碼" name="password" /> </div>
                        ...
                        {{-- <div id="code">
                                    ...
                                    <div id="code_img">
                                        <img src="{{url('code')}}" alt=""
                        onclick="this.src='{{url('code')}}?'+Math.random()">
                    </div>
                </div>
                <div>
                ...
                <div class="form-actions">
                    <a href="javascript:;" class="btn uppercase"
