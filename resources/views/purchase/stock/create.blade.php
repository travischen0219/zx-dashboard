...
<style>
    ...
    #loader {
        ...
        height: 100%;
        z-index: 9999;
        background: url('../assets/apps/img/loader_icon.gif') 50% 50% no-repeat rgb(249,249,249);
    ...
    <div class="col-md-12 ">
        ...
        <div class="portlet light">
            ...
            <div class="portlet-body form">
                <form role="form" action="{{ route('stock.store') }}" method="POST" id="stock_from">
                    {{ csrf_field() }}
                    <div class="form-body">
