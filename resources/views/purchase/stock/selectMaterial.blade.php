...
<div class="page-content">
    ...
    <div class="row">
        <div class="col-md-12" >
            <form role="form" action="{{ route('selectMaterial_stock.search') }}" method="POST" id="search_from">
                {{ csrf_field() }}
            ...
            <div class="portlet light">
                <div class="portlet-title">
                    ...
                    <div class="caption font-dark">
                        <span style="color:red;">無預設倉儲位置之物料，將自動以第一次入庫之倉儲位置做為預設倉儲位置</span>
                    </div>
                    <div class="tools"> </div>
                </div>
                            ...
                            @foreach($materials as $material)
                                ...
                                <tr>
                                    <td align="center" id="functions_btn">
                                        <a href="javascript:;" class="btn blue btn-outline btn-sm" onclick="parent.setMaterial('{{$material->fullCode}}','{{$material->fullName}}','{{$material->buy}}','{{$material->unit}}','{{$material->price}}','{{$material->id}}','{{$material->warehouse > 0 ? $material->warehouse_name->code : ''}}','{{$material->warehouse > 0 ? $material->warehouse : ''}}','{{$material->material_unit_name->name}}','{{$material->stock}}');">選擇</a>    
                                    </td>
