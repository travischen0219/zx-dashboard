    ...
    <div class="col-md-12 ">
        ...
        <div class="portlet light">
            ...
            <div class="portlet-body form">
                <form role="form" action="{{ route('buy.store') }}" method="POST" id="buy_from">
                    {{ csrf_field() }}
                    <div class="form-body">
                        ...
                        <div class="col-md-12" style="height:90px;">
                            ...
                            <div class="col-md-3" style="font-size: 16px;color:#248ff1;line-height: 50px;">
                                供應商 :
                                <button id="select_supplier" type="button" class="btn blue"
                                    onclick="selectSupplier();">按此選擇</button>
                                <input type="hidden" id="supplier" name="supplier">
                            </div>
                            <div class="col-md-3" style="font-size: 16px;color:#248ff1;line-height: 50px;">
                                狀態 : <span style="color:#000">未採購</span>
                            </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-3">
                                <div class="form-group form-md-line-input">
                                    <input type="text" name="buyDate" class="form-control" autocomplete="off"
                                        id="datepicker01" value="{{ old('buyDate') }}">
                            ...
                            <div class="col-md-3">
                                <div class="form-group form-md-line-input">
                                    <input type="text" name="expectedReceiveDate" class="form-control"
                                        autocomplete="off" id="datepicker02" value="{{ old('expectedReceiveDate') }}">
                            ...
                            <div class="col-md-12">
                                <div class="form-group form-md-line-input">
                                    <textarea class="form-control" rows="3" name="memo"
                        ...
                        <div class="col-md-12">
                            <buy-table :rows="rows" :units="units" ref="materialTable">
                            </buy-table>
                        </div>
...
<button id="error_supplier" class="btn btn-danger mt-sweetalert" data-title="尚未選擇 供應商" data-message=""
    data-allow-outside-click="true" data-confirm-button-class="btn-danger" style="display: none;"></button>
<button id="error_buyDate" class="btn btn-danger mt-sweetalert" data-title="採購日期 必填" data-message=""
    data-allow-outside-click="true" data-confirm-button-class="btn-danger" style="display: none;"></button>
<button id="error_expectedReceiveDate" class="btn btn-danger mt-sweetalert" data-title="預計到貨日 必填" data-message=""
    data-allow-outside-click="true" data-confirm-button-class="btn-danger" style="display: none;"></button>
...
<script>
    ...
    function setMaterial(code, name, buy, unit, cost, price, id, unit_name, warehouse_name, warehouse_id, cal_unit,
        cal_price, stock) {
    ...
    function openMaterial_module() {
        $.magnificPopup.open({
            ...
            type: 'iframe',
            items: {
                src: "{{route('selectMaterial_module_inventory')}}"
            }
        });
    }
