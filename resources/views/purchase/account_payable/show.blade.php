        ...
        <div class="portlet light">
            <div class="portlet-title">
                ...
                <div class="caption font-dark">
                    <a href="{{ route('account_payable.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> 新增應付帳款</a>
                </div>
                <div class="tools"> </div>
            </div>
                            ...
                            <tr>
                                ...
                                <td align="center" id="functions_btn">
                                    @if($account_payable->status == 1)
                                        <a href="{{ route('account_payable.edit', $account_payable->id) }}" class="btn blue btn-outline btn-sm">修改</a>
                                    @elseif($account_payable->status == 2 || $account_payable->status == 3)
                                        <a href="{{ route('account_payable.edit', $account_payable->id) }}" class="btn purple btn-outline btn-sm">查看</a>
                                    @endif
                                    ...
                                    <form id="delete-form-{{$account_payable->id}}" action="{{ route('account_payable.destroy', $account_payable->id) }}" method="post" style="display:none">
                                        {{ csrf_field() }}
                                        {{ method_field('DELETE') }}
                                    </form>
                                </td>
