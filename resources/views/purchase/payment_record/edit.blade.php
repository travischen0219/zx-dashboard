                ...
                <form role="form" action="{{ route('account_payable.update',$account_payable->id) }}" method="POST" id="account_payable_from">
                    ...
                    <div class="form-body">
                        ...
                        <div class="col-md-12" style="height:90px;">
                            ...
                            <div class="col-md-3">
                                <div class="form-group form-md-line-input" >
                                    ...
                                    @else
                                        <input type="text" name="buy_no" class="form-control" id="buy_no" @if($account_payable->status == 2 || $account_payable->status== 3) disabled @endif>
                                    @endif
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-3">
                                <div class="form-group form-md-line-input" >
                                    <input type="text" name="payDate" class="form-control" autocomplete="off" id="datepicker02" value="" @if($account_payable->status == 2 || $account_payable->status== 3) disabled @endif>
