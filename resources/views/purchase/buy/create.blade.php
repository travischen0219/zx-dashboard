                ...
                <form role="form" action="{{ route('buy.store') }}" method="POST" id="buy_from">
                    ...
                    <div class="form-body">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-3">
                                <div class="form-group form-md-line-input" >
                                    <input type="text" name="buyDate" class="form-control" autocomplete="off" id="datepicker01" value="{{ old('buyDate') }}">
                            ...
                            <div class="col-md-3">
                                <div class="form-group form-md-line-input" >
                                    <input type="text" name="expectedReceiveDate" class="form-control" autocomplete="off" id="datepicker02" value="{{ old('expectedReceiveDate') }}">
