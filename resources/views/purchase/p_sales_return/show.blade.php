...
<div class="row">
    <form role="form" action="{{ route('p_sales_return.search') }}" method="POST">
        {{ csrf_field() }}
        <div class="col-md-12" >
    ...
    <form role="form" action="{{ route('p_sales_return.create') }}" method="GET" id="create_from">
...
<input type="checkbox" class="print_pdf" name="print_pdf"  value="{{$buy->id}}">
                                ...
                                <td>{{$buy->memo_return}}</td>
                                <td>{{$buy->returnDate}}</td>
                                <td>{{$buy->realReturnDate}}</td>
                                <td>
                                    @if($buy->status == '1') 
                                ...
                                <td align="center" id="functions_btn">
                                    ...
                                    @if($buy->status_return == 1)
                                        <a href="{{ route('p_sales_return.edit', $buy->id) }}" class="btn blue btn-outline btn-sm">修改</a>
                                    @elseif($buy->status_return == 2)
                                        <a href="{{ route('p_sales_return.edit', $buy->id) }}" class="btn purple btn-outline btn-sm">查看</a>
                                    @endif
