    ...
    <div class="col-md-12 ">
        ...
        <div class="portlet light">
            ...
            <div class="portlet-body form">
                <form role="form" action="{{ route('inquiry.store') }}" method="POST" id="inquiry_from">
                    {{ csrf_field() }}
                    <div class="form-body">
                        ...
                        <div class="col-md-12" style="height:90px;">
                            ...
                            <div class="col-md-3" style="font-size: 16px;color:#248ff1;line-height: 50px;">
                                詢價狀態 : <span style="color:#000">未成交</span>
                            </div>

                            <div class="col-md-3" style="font-size: 16px;color:#248ff1;line-height: 50px;">
                                詢價單號 : <span style="color:#000">R{{$inquiry_no}}</span>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-3">
                                <div class="form-group form-md-line-input" >
                                    <input type="text" name="askDate" class="form-control" autocomplete="off" id="datepicker01" >
                            ...
                            <div class="col-md-3">
                                <div class="form-group form-md-line-input" >
                                    <input type="text" name="expireDate" class="form-control" autocomplete="off" id="datepicker02" >
...
function addMaterial() {
    $.post(
        "{{ route('selectMaterial_inquery.addRow') }}",
...
function setMaterial(code,name,buy,unit,cost,price,id,unit_name,warehouse_name,warehouse_id,cal_unit,cal_price){
    ...
    // $('#materialUnit_show' + currentMaterial).html(cal_unit_name);
    $('#materialUnit' + currentMaterial).val(cal_unit);
    $('#materialPrice' + currentMaterial).val(cal_price);
...
function setMaterial_module(module_id){
    $.magnificPopup.close();
    $.post(
        "{{ route('selectMaterialModule_inquery.addModule') }}",
