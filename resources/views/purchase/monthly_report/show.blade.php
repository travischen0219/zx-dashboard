        ...
        <div class="col-md-12">
            ...
            <div class="portlet light">
                ...
                <div class="portlet-body">
                    ...
                    <div class="col-md-12" style="line-height: 80px;">
                        <span style="color:#248ff1;font-size: 16px;line-height: 32px;text-align: center"> 匯出欄位 : </span>
                        <input type="checkbox" id="col" name="col" value="name" checked>品名 
...
function pdfsubmit()
{
    ...
    openInNewTab("/pdf/monthly.php?start="+start+"&end="+end+"&lot_number="+lot_number+"&supplier="+supplier+"&col="+col);
