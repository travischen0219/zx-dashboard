            ...
            <div class="portlet light">
                ...
                <div class="portlet-body">
                    <table class="table table-striped table-bordered table-hover" id="sample_2" >
                        ...
                        <tbody>
                            @foreach($selectMaterials as $material)
                                @if(true)
                                <tr>
                                    <td align="center" id="functions_btn">
                                        <a href="javascript:;" class="btn blue btn-outline btn-sm" onclick="parent.setMaterial('{{$material->fullCode}}','{{$material->fullName}}','{{$material->buy}}','{{$material->unit}}','{{$material->cost}}','{{$material->price}}','{{$material->id}}','{{$material->material_unit_name->name}}','{{$material->warehouse > 0 ? $material->warehouse_name->code : ''}}','{{$material->warehouse > 0 ? $material->warehouse : ''}}');">選擇</a>    
                                    </td>
