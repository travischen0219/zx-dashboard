                        ...
                        @foreach($suppliers as $supplier)
                            ...
                            <tr>
                                ...
                                <td align="center" id="functions_btn">
                                    ...
                                    <a href="{{ route('supplier.edit', $supplier->id) }}" class="btn blue btn-outline btn-sm">修改</a>
                                    ...
                                    <a href='
                                        @if($supplier->code != '' && $supplier->fullName != '')
                                            javascript: barcode("{{$supplier->fullName}}", "{{$supplier->code}}");' class="btn green btn-outline btn-sm">條碼</a>
                                        @else
