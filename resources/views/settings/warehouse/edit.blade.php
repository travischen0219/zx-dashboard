                ...
                <form role="form" action="{{ route('warehouses.update',$warehouse->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-body">
                        ...
                        <div class="col-md-12">
                            <div class="col-md-6">
                                <div class="form-group form-md-line-input form-md-floating-label">
                                    ...
                                    <label for="form_control_2"><span style="color:red;">*</span>倉儲編號<span style="color:red;"> (不可更改)</span></label>
                                    <span class="help-block"></span>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group form-md-line-input form-md-floating-label">
                                    <input type="text" name="fullName" class="form-control" id="form_control_3" value="{{ $warehouse->fullName }}">
                        ...
                        <div class="col-md-12">
                            <div class="col-md-6">
                                <div class="form-group form-md-line-input form-md-floating-label">
                                    <input type="text" name="location" class="form-control" id="form_control_4" value="{{ $warehouse->location }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group form-md-line-input form-md-floating-label">
                                    <input type="text" name="size" class="form-control" id="form_control_5" value="{{ $warehouse->size }}">
                                ...
                                <div class="col-md-10">
                                    <div class="md-radio-inline">
                                        ...
                                        <div class="md-radio has-error">
                                            <input type="radio" id="radio2" name="status" class="md-radiobtn" value="2" {{ $warehouse->status == 2 ? 'checked' : '' }}>
                                            <label for="radio2">
                                                <span></span>
                                                <span class="check"></span>
                                                ...
                                                <p style="margin-top:6px;margin-bottom: 50px">
                                                    <a href="javascript:;" class="btn red pull-right btn-sm" role="button" onclick="
                                                        if(confirm('確定要刪除嗎 ?')){
                                                            ...
                                                            document.getElementById('delete-form-{{$warehouse->image_1->id}}').submit();
                                                        } else {
                                                            event.preventDefault();
                                                        }">刪除</a>
                                            ...
                                            <div class="caption">
                                                ...
                                                <p style="margin-top:6px;margin-bottom: 50px">
                                                    <a href="javascript:;" class="btn red pull-right btn-sm" role="button" onclick="
                                                        if(confirm('確定要刪除嗎 ?')){
                                                            event.preventDefault();
                                                            document.getElementById('delete-form-{{$warehouse->image_2->id}}').submit();
                                                        } else {
                                                            event.preventDefault();
                                                        }">刪除</a>
                                            ...
                                            <div class="caption">
                                                ...
                                                <p style="margin-top:6px;margin-bottom: 50px">
                                                    <a href="javascript:;" class="btn red pull-right btn-sm" role="button" onclick="
                                                        if(confirm('確定要刪除嗎 ?')){
                                                            event.preventDefault();
                                                            document.getElementById('delete-form-{{$warehouse->image_3->id}}').submit();
                                                        } else {
                                                            event.preventDefault();
                                                        }">刪除</a>
...
@if($warehouse->file_1 > 0)
    <form id="delete-form-{{$warehouse->image_1->id}}" action="{{ url('settings/warehouse_file/delete/1/'. $warehouse->id.'/'.$warehouse->image_1->id) }}" method="post" style="display:none">
        {{ csrf_field() }}
    </form>
@endif
@if($warehouse->file_2 > 0)
    <form id="delete-form-{{$warehouse->image_2->id}}" action="{{ url('settings/warehouse_file/delete/2/'. $warehouse->id.'/'.$warehouse->image_2->id) }}" method="post" style="display:none">
        {{ csrf_field() }}
    </form>
@endif
@if($warehouse->file_3 > 0)
    <form id="delete-form-{{$warehouse->image_3->id}}" action="{{ url('settings/warehouse_file/delete/3/'. $warehouse->id.'/'.$warehouse->image_3->id) }}" method="post" style="display:none">
        {{ csrf_field() }}
    </form>
@endif
