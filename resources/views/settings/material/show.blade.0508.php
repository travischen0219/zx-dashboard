        ...
        <div class="portlet light">
            <div class="portlet-title">
                ...
                <div class="caption font-dark">
                 ...
                 <div class="caption font-dark" style="margin-left:5px">
                    <span class="btn btn-primary" onclick="pdfsubmit_all();"><i class="fa fa-print"></i> 全部條碼列印</span>
                </div>
                 <div class="caption font-dark" style="margin-left:5px">
                    <span class="btn btn-primary" onclick="pdfsubmit_one();"><i class="fa fa-print"></i> 多筆條碼列印</span>
                </div>
                <div class="tools"> </div>
            </div>
            ...
            <div class="portlet-body">
                <table class="table table-striped table-bordered table-hover" id="sample_1" >
                    <thead>
                        <tr>
                            <th><input name="clickAll" id="clickAll" type="checkbox"> 全選條碼</th>
                            <th>編 號</th>
                            <th>分 類</th>
                            <th>品 名</th>
                            <th>單 位</th>
...
function pdfsubmit_one()
{
            ...
            openInNewTab("/pdf/barcode.php?id="+selected);
            
        
    
}
function pdfsubmit_all()
{
           
           
            openInNewTab("/pdf/barcode.php?id=all");
...
$("#clickAll").click(function() {
   if($("#clickAll").prop("checked")) {
     $("input[name='print_pdf']").each(function() {
