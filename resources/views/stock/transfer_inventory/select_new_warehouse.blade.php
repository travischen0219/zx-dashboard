...
<div class="page-content">
        ...
        <div class="row">
            <form role="form" action="{{ route('selectNewWarehouse_stock.search') }}" method="POST">
                {{ csrf_field() }}
                <div class="col-md-12" >
                                ...
                                <div class="col-md-6">
                                    <div class="info-box">
                                        <div class="icon bg-cyan">
                                            <a href='javascript: fun2("{{$warehouse->id}}", "{{$warehouse->fullName}}", "{{$warehouse->code}}", "{{$warehouse->warehouse_category->name}}");'>
                                                    ...
                                                    <div>{{$warehouse->code}}
                                                        ...
                                                        @else
                                                            @foreach($material_warehouses as $material_warehouse)
                                                                @if($material_warehouse->warehouse_id == $warehouse->id)
                                                                    <span style="color:red;">庫存 : {{$material_warehouse->stock}}</span>
                                                                @endif
                                                            @endforeach
                                                        @endif
                                                    </div>
...
function fun2(id,fullName,code,category){
    parent.setNewWarehouse(id,fullName,code,category);
}
