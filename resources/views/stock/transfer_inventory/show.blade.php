...
<div class="row">
     <form role="form" action="{{ route('transfer_inventory.search') }}" method="POST">
        {{ csrf_field() }}
        <div class="col-md-12" >
        ...
        <div class="portlet light">
            <div class="portlet-title">
                ...
                <div class="caption font-dark">
                    <a href="{{ route('transfer_inventory.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> 新增調撥</a>
                </div>
                <div class="tools"> </div>
            </div>
                    ...
                    <tbody>
                        @foreach($transfers as $transfer)
                            ...
                            <tr>
                                ...
                                <td>{{ $transfer->material_name->fullName }}</td>
                                <td align="center">{{ $transfer->quantity }}</td>
                                <td align="center">{{ $transfer->o_warehouse_name->code }}</td>
                                <td align="center">{{ $transfer->original_calculate_quantity }}</td>
                                <td align="center">{{ $transfer->n_warehouse_name->code }}</td>
                                <td align="center">{{ $transfer->new_calculate_quantity }}</td>
                            </tr>
