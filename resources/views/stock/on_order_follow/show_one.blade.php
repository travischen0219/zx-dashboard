                ...
                {{-- <form role="form" action="{{ route('buy.update',$buy->id) }}" method="POST" id="buy_from">
                    ...
                    <div class="form-body">
                        ...
                        <div class="col-md-12" style="height:90px;">
                            ...
                            @if($buy->status == 1 || $buy->status == 2 || $buy->status == 3)
                                <div class="col-md-3">
                                    <div class="form-group form-md-line-input">
                            ...
                            @elseif($buy->status == 4)
                                <div class="col-md-3" style="font-size: 16px;color:#248ff1;line-height: 50px;">
                                    採購狀態 : <span style="color:blue">已成交</span> 
                                </div>
                            @endif
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-3">
                                <div class="form-group form-md-line-input" >
                                    <input type="text" name="buyDate" class="form-control" id="datepicker01" value="{{ $buy->buyDate }}" disabled>
                            ...
                            <div class="col-md-3">
                                <div class="form-group form-md-line-input" >
                                    <input type="text" name="expectedReceiveDate" class="form-control" id="datepicker02" value="{{ $buy->expectedReceiveDate }}" disabled>
                            ...
                            <div class="col-md-12">
                                <div class="form-group form-md-line-input">
                                    <textarea class="form-control" rows="3" name="memo" id="memo" disabled>{{ $buy->memo }}</textarea>
