    ...
    <div class="col-md-12 ">
        ...
        <div class="portlet light">
            ...
            <div class="portlet-body form">
                <form role="form" action="{{ route('semi_finished_schedule.store') }}" method="POST" id="stock_from">
                    {{ csrf_field() }}
                    <div class="form-body">
                        ...
                        <div class="col-md-12" style="height:90px;">
                            ...
                            <div class="col-md-3">
                                <div class="form-group form-md-line-input" >
                                    <input type="text" name="start_date" class="form-control" autocomplete="off" id="datepicker01">
                            ...
                            {{-- <div class="col-md-3">
                                <div class="form-group form-md-line-input" >
                                    <input type="text" name="end_date" class="form-control" autocomplete="off" id="datepicker02">
                                    <label for="datepicker02" style="color:#248ff1;">結束日期 (YYYY-MM-DD)</label>
                                    <span class="help-block"></span>
                                </div>
                            </div> --}}
                        </div>
...
<button id="error_start_date" class="btn btn-danger mt-sweetalert" data-title="開始日期 必填" data-message="" data-allow-outside-click="true" data-confirm-button-class="btn-danger" style="display: none;"></button>
...
function submit_btn(){
    ...
    $(".materialRow").each(function(index, el) {
        ...
        if($(this).find(".materialAmount").val() == '' || $(this).find(".materialAmount").val() <= 0){
            check_quantity++
        }
