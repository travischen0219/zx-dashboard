    ...
    <div class="col-md-12 ">
        ...
        <div class="portlet light">
            ...
            <div class="portlet-body form">
                <form role="form" action="{{ route('semi_finished_schedule.update',$processing->id) }}" method="POST" id="sale_from" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    {{ method_field('PUT') }}
                    ...
                    <div class="form-body">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-3">
                                <div class="form-group form-md-line-input" >
                                    <input type="text" name="start_date" class="form-control" autocomplete="off" id="datepicker01" disabled>
                            ...
                            <div class="col-md-3">
                                <div class="form-group form-md-line-input" >
                                    <input type="text" name="end_date" class="form-control" autocomplete="off" id="datepicker02" {{ $processing->status == 2 ? 'disabled' : ''}}>
                            ...
                            <div class="col-md-12">
                                <div class="form-group form-md-line-input">
                                    <textarea class="form-control" rows="3" name="memo" id="memo">{{ $processing->memo }}</textarea>
