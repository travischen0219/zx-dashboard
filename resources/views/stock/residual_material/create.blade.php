    ...
    <div class="col-md-12 ">
        ...
        <div class="portlet light">
            ...
            <div class="portlet-body form">
                <form role="form" action="{{ route('residual_material_processing.store') }}" method="POST" id="stock_from">
                    {{ csrf_field() }}
                    <div class="form-body">
                        ...
                        <div class="col-md-12" style="height:90px;">
                            ...
                            <div class="col-md-3">
                                <div class="form-group form-md-line-input" >
                                    <input type="text" name="processing_date" class="form-control" autocomplete="off" id="datepicker01" value="{{ old('processing_date') }}">
                        ...
                        <div class="col-md-12">
                            <div class="form-actions noborder">
                                ...
                                <a href="{{ route('residual_material_processing.index') }}" class="btn red"><i class="fa fa-times"></i> 取 消</a>
                            </div>
                        </div>
                    </div>
...
<button id="error_amount" class="btn btn-danger mt-sweetalert" data-title="處理數量不可為零或負值" data-message="" data-allow-outside-click="true" data-confirm-button-class="btn-danger" style="display: none;"></button>
...
function setMaterial(code,name,buy,unit,cost,price,id,warehouse_name,unit_name,stock,warehouse_id,warehouse_code){
    $.magnificPopup.close();
    var str = code+' '+name;
