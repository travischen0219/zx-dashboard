...
<div class="page-content">
    <div class="row">
        <div class="col-md-12" >
            <form role="form" action="{{ route('selectManufacturer.search') }}" method="POST" id="search_from">
                {{ csrf_field() }}
        ...
        <div class="col-md-12">
            ...
            <div class="portlet-title">
                ...
                <div class="caption font-dark" style="margin-left:20px;">
                    <a href="{{ route('createManufacturer') }}" class="btn btn-primary"><i class="fa fa-plus"></i> 新增廠商</a>
                </div>
                <div class="tools"> </div>
            </div>
                            ...
                            @foreach($manufacturers as $manufacturer)
                                ...
                                <tr>
                                    <td align="center" id="functions_btn">
                                        <a href="javascript:;" class="btn blue btn-outline btn-sm" onclick="parent.setManufacturer('{{$manufacturer->code}}','{{$manufacturer->shortName}}','{{$manufacturer->id}}');">選擇</a>
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        @if($manufacturer->category == '')
                                            未設定
                                        @elseif($manufacturer->category == 1)                                    
                                            常用
                                        @elseif($manufacturer->category == 2)
                                            不常用
                                        @endif
                                    </td>
