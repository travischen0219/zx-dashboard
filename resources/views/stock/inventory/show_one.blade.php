                ...
                <form role="form" action="{{ route('inventory.update',$inquiry->id) }}" method="POST" id="inquiry_from">
                    ...
                    <div class="form-body">
                        ...
                        <div class="col-md-12" style="height:90px;">
                            ...
                            <div class="col-md-3">
                                <div class="form-group form-md-line-input" >
                                    <input type="text" name="lot_number" class="form-control" id="lot_number" value="{{ $inquiry->lot_number }}" disabled>
                            ...
                            <div class="col-md-3" style="font-size: 16px;color:#248ff1;line-height: 50px;">
                                盤點單號 : <span style="color:#000">INV{{$inquiry->inventory_no}}</span> 
                            </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-3">
                                <div class="form-group form-md-line-input" >
                                    <input type="text" name="inventory_sdate" class="form-control" id="datepicker01" disabled>
                            ...
                            <div class="col-md-3">
                                <div class="form-group form-md-line-input" >
                                    <input type="text" name="inventory_edate" class="form-control" id="datepicker02" disabled>
                            ...
                            <div class="col-md-12">
                                <div class="form-group form-md-line-input">
                                    <textarea class="form-control" rows="3" name="memo" id="memo" disabled>{{ $inquiry->memo }}</textarea>
