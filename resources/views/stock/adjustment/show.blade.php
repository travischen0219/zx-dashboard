...
<div class="row">
     <form role="form" action="{{ route('adjustment.search') }}" method="POST">
        {{ csrf_field() }}
        <div class="col-md-12" >
        ...
        <div class="portlet light">
            <div class="portlet-title">
                ...
                <div class="caption font-dark">
                    <a href="{{ route('adjustment.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> 新增誤差處理</a>
                </div>
                <div class="tools"> </div>
            </div>
